...
const GPT_QUALITY = 'high';                // latency is quality-independent on this router, so take best fidelity
...
const COST_PER_LOOK = 0.13;     // GPT Image 2 @ high (approx, incl. input photos)
...
function renderOutfitBar() {
  ...
  $('#outfit-bar').innerHTML = `<div class="outfit-inner">
    ...
    <span class="model-badge" title="Image engine">GPT Image 2 · high</span>
    ${state.generating
